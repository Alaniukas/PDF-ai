const testimonials = [
  ...
  },
  {
    ...
    stars: 4,
    text: "labai padėjo tik gale trūko dar vieno pavyzdžio su word bet apskritai aišku ir naudoju jau antrą savaitę",
  },
  {
    name: "Irena",
    age: 44,
  ...
  },
  {
    ...
    stars: 4,
    text: "Geras gidas. Video skambutį teko palaukt kelias dienas, bet kai susiskambinom — viskas susidėliojo.",
  },
  {
    name: "Dalia",
    age: 56,
    ...
    stars: 5,
    text: "Bijojau, kad bus per sudėtinga techniškai... O čia parašyta paprastai — lyg kolegė paaiškintų prie kavos.",
  },
  {
    name: "Onutė",
    age: 49,
    ...
    stars: 4,
    text: "santraukos dabar darau per puse laiko truksta tik vieno skyriaus apie outlook bet likusiu patenkinta",
  },
  {
    name: "Rita",
    age: 41,
    role: "HR asistentė",
    stars: 5,
    text: "premium paketas tikrai vertas!! per video skambuti padėjo viska susidėliot kompe dabar naudoju kasdien",
  },
  {
    name: "Giedrė",
    age: 35,
    ...
    stars: 4,
    text: "Patiko, kad ne bendras vadovėlis, o pagal mano darbą. Vienintelis minusas — norėčiau dar ilgesnio checklist.",
  },
];
